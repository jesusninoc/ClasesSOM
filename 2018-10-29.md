...
```PowerShell
cd .\1usuario
Ac -Path .\fichero1.txt -Value "1Hola"
cd ..
cd C:\2usuario
Ac -Path .\fichero2.txt -Value "2Hola"
cd ..
cd C:\3usuario
Ac -Path .\fichero3.txt -Value "3Hola"
cd ..
```
...
```PowerShell
Rni .\3usuario -newname "100usuario"
```
- Mover archivos de una carpeta a otra
```Powershell
mi .\fichero.txt -destination .\2usuario
```
